...
import com.kai.githubuser.databinding.FavoriteListBinding
...
class FavoriteUserAdapter : RecyclerView.Adapter<FavoriteUserAdapter.FavoriteUserViewHolder>() {
    ...
    inner class FavoriteUserViewHolder(private val binding: FavoriteListBinding) : RecyclerView.ViewHolder(binding.root) {
        fun bind(favoriteUser: FavoriteUser) {

            with(binding) {
                name.text = favoriteUser.username
                urlItem.text = favoriteUser.avatarUrl
